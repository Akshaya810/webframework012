package com.example.class_exercise_1.Akshumodel;

import jakarta.persistence.Entity;
import jakarta.persistence.Id;

@Entity
public class AkshuChildren {
     @Id
     private int babyId;
     ...
     public AkshuChildren() {

     }

     public AkshuChildren(int babyId, String babyFirstName, String babyLastName, String fatherName, String motherName,
               String address) {
          this.babyId = babyId;
